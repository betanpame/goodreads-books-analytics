## Task 02 – Structure Portfolio Case Study

### Objective

Design a **case study structure** that you can use in your portfolio or as a blog post based on this project.
...
4. **Identify gaps for future improvement**
   - Add a small "Next Steps" bullet list:
     - Ideas for deeper analysis or more advanced modeling.
     - Potential dashboard or app extensions.
     - Additional data you would like to have.

### Checklist

- [ ] Case study outline file created.
- [ ] High-level sections and bullets defined.
- [ ] Mapping from sections to project assets written.
- [ ] Next-steps ideas listed.
