# Task 02 – Write core README content

## Objective

Fill in the main sections of `README.md` with clear, professional text, avoiding unnecessary jargon.
...
- [ ] Review the text to make sure a non-technical person can understand it.

## Expected outcome

A `README.md` with the main sections written, even if you still need to refine details about results or links.
