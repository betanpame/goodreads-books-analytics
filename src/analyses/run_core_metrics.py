"""Generate Phase 04 Step 02 Task 02 core metrics tables.

The script stays inside the Python/Docker workflow, reads ``books_clean.csv``,
computes the core metrics (M1, M3, M4, M5, M7, M8, M9, M11), and saves the
results to CSV for portfolio sharing.
"""
